...
public class LatestDishes {
    String idMeal;
    String strMeal;
    String idMestrDrinkAlternateal;
    String strCategory;
    String strArea;
    ...
    public String getIdMestrDrinkAlternateal() {
        return idMestrDrinkAlternateal;
    }

    public void setIdMestrDrinkAlternateal(String idMestrDrinkAlternateal) {
        this.idMestrDrinkAlternateal = idMestrDrinkAlternateal;
    }
